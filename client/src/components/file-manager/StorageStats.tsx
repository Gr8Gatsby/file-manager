          ...
          <div className="space-y-4">
            ...
            <CollapsibleContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-sm font-medium text-foreground">Original Size</div>
                ...
                <motion.div
                  ...
                  className="rounded-lg p-3 bg-muted/80 dark:bg-muted/50"
                >
                  <div className="text-sm font-medium text-foreground">Compressed Size</div>
                  <div className="text-2xl font-bold text-foreground">{formatSize(compressed)}</div>
                </motion.div>
              </div>
            </CollapsibleContent>
          </div>
